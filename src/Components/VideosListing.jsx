...
const VideosListing = ({ data }) => {
  ...
  return (
    <Link to={`/videos/${_id}`} className="mb-12">
      <div className="text-textColor bg-primary w-[380px] h-[300px] cursor-pointer hover:scale-110   duration-150 rounded-md font-medium relative group">
        {/* clock div */}
